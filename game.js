...
const places={garden:[{x:22,y:63,r:12,name:'貼紙祝福板',board:true},{x:45,y:29,r:12,name:'伊薩克',art:'special mature',text:'歡迎。',action:'送上新婚祝福 ♡'},{x:57,y:29,r:12,name:'白冥',art:'sprite s1',text:'歡迎來到我們的婚禮～',action:'送上新婚祝福 ♡'},{x:22,y:40,r:13,name:'鮑里斯',art:'special boris',text:'「嗚！」四肢著地的鮑里斯抬起頭，輕輕嗅了嗅空氣，脖子上的藍色蝴蝶結也跟著晃了晃。',action:'向鮑里斯打招呼 ♡'},{x:22,y:72,r:15,name:'花園蛋糕',text:'小巧的藍白奶油花，藏著甜甜的心意。宴會廳裡還有大婚禮蛋糕等著你！',action:'品嚐一小口 ♡'}],hall:[{x:37,y:37,r:11,name:'薩維里',child:'saviri',art:'child-portrait',text:'薩維里把小花籃抱在懷裡，輕輕點頭。「這朵……給你。」他安安靜靜地挑了一朵小白花。',action:'收下小白花，陪他坐一會兒 ♡'},{x:63,y:37,r:11,name:'狄安娜',child:'diana',art:'child-portrait',text:'「你看、你看！花花飛起來了！」狄安娜晃著藍色蝴蝶結，開心地把花瓣分給你。「一起玩嘛～」',action:'和狄安娜一起玩撒花 ♡'},{x:50,y:49,r:17,name:'大結婚蛋糕',text:'層層白色奶油綴著藍色花朵，這座大蛋糕是今天最甜蜜的主角。一起分享伊薩克與白冥的幸福吧。',action:'享用婚禮蛋糕 ♡'},{x:19,y:33,r:12,name:'花好月圓（炸湯圓）',text:'粉紅與金黃的小湯圓炸得外酥內軟，撒上香甜花生粉。花好月圓，祝新人團團圓圓、甜甜蜜蜜！',action:'品嚐花好月圓 ♡'},{x:83,y:34,r:13,name:'婚宴佳餚',text:'香烤雞肉、鮮蝦與熱騰騰的料理已經上桌，為今天的相聚添上豐盛的滋味。',action:'享用美食 ♡'},{x:83,y:55,r:14,name:'水果與甜點',text:'繽紛水果、精緻小蛋糕與甜點擺滿了餐桌，挑一份喜歡的，慢慢享用吧。',action:'拿一份甜點 ♡'}]};
